...
use App\Http\Controllers\TripEstimateController;
use Illuminate\Support\Facades\Route;

// 1. Ana dizine gelen isteği t-r-takip/dashboard'a gönder
Route::get('/', function () {
    return redirect()->route('dashboard');
});

// 2. Tüm rotaları 't-r-takip' önekiyle grupla
Route::prefix('t-r-takip')->group(function () {

    // Alt klasör içindeki ana sayfa yönlendirmesi
    Route::get('/', function () {
        return redirect()->route('dashboard');
    });
    ...
    Route::middleware(['ensure.user'])->group(function () {
        ...
        Route::middleware(['patron'])->group(function () {
            ...
            Route::get('/aylik-ozet', [MonthlySummaryController::class, 'index'])
        ...
        Route::get('/trips/estimate-km', TripEstimateController::class)->name('trips.estimate-km');
        ...
        Route::get('/trip-stops/create', [TripStopController::class, 'create'])->name('trip-stops.create');
        Route::post('/trip-stops', [TripStopController::class, 'store'])->name('trip-stops.store');
        Route::delete('/trip-stops/{tripStop}', [TripStopController::class, 'destroy'])->name('trip-stops.destroy');
    ...
    // Auth rotalarını da bu grubun içine alıyoruz
